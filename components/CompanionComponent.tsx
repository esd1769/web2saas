            ...
            <section className='flex gap-8 max-sm:flex-col '>
                <div className='companion-section'>
                    <div className='companion-avatar' style={{backgroundColor:
                        ...
                        <div
                            ...
                            {/*<Image src='/icons/headset.svg' alt='headset'*/}
                            {/*       width={100} height={100}*/}
                            {/*       className='companion-headset'/>*/}
                        </div>
                        <div
                            className={
                                cn(
                ...
                <div className='user-section'>
                    <div className='user-avatar'>
                        <Image src={userImage}
                               alt={userImage} width={130} height={130}
                               className='rounded-lg'/>
                        <p className='font-bold text-2xl'>{userName}</p>
                    </div>
                    <button className='btn-mic' onClick={toggleMicrophone}>

                            <Image src={isMuted ? '/icons/mic-off.svg':'/icons/mic-on.svg'}alt='mic'
                                   width={36} height={36}/>
                        <p className='max-sm:hidden'>
                            {isMuted ? 'Turn on microphone':' turn off micprophone'}
                    ...
                    <button className={cn(
                        ...
                        callStatus === CallStatus.CONNECTING && 'animate-pulse'
                            ...
                            onClick={callStatus === CallStatus.ACTIVE ?
                                handleDisconnectCall : handleCall}>
